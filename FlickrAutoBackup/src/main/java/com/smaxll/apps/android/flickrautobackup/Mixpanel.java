...
public class Mixpanel {
    ...
    public static final String MIXPANEL_TOKEN = "03e392348156e66f2d9293f8078f292b";

	private static MixpanelAPI mixpanel;

	private static void ensureMixpanel() {
		if (mixpanel == null) {
			mixpanel = MixpanelAPI.getInstance(FlickrAutoBackup.getAppContext(), MIXPANEL_TOKEN);
			try {
